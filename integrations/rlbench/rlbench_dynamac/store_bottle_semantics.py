...
def extract_store_bottle_semantic_episode(episode: Any) -> Any:
    ...
    from .demo_adapter import extract_bimanual_episode
...
def make_store_bottle_semantic_demonstrations(
    ...
    **kwargs: Any,
    ...
    from .demo_adapter import make_bimanual_demonstrations
...
def store_bottle_semantic_observations_from_rlbench(
    ...
    from .runtime import bimanual_observations_from_rlbench
