...
DEFAULT_DATA_DIR = INTEGRATION_ROOT / "data" / "v4" / "store_bottle"
...
def load_store_bottle_training_protocol(path=TRAINING_PROTOCOL_PATH):
    ...
    if (
        ...
        != "integrations/rlbench/data/v4/store_bottle"
...
def load_store_bottle_collection_manifest(path=None, verify_files=True):
    ...
    from .store_bottle_semantics import store_bottle_policy_spec_identity
...
def build_store_bottle_training_identity(
    ...
    from .direct_policy import v4_quaternion_batch_gauge_identity
...
def train_store_bottle_v4(
    ...
    from .direct_policy import TRAINING_MANIFEST_SCHEMA_V4, train_task
    from .store_bottle_semantics import store_bottle_semantic_task_spec
...
def serve_store_bottle_v4(models_dir=DEFAULT_MODELS_DIR):
    ...
    from .direct_policy import serve
...
def main(argv=None):
    ...
    if args.command == "collect":
        ...
        from .store_bottle_release_v4 import (
