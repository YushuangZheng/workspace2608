...
from integrations.rlbench.rlbench_dynamac import direct_policy
...
from integrations.rlbench.rlbench_dynamac.store_bottle_release_v4 import (
    INHERITED_MODE,
    RETRAINED_MODE,
    build_model_release_manifest,
    load_model_release_plan,
)
from integrations.rlbench.rlbench_dynamac.store_bottle_semantics import (
    STORE_BOTTLE_TASK_NAME,
    store_bottle_policy_spec_identity,
)
from integrations.rlbench.rlbench_dynamac.store_bottle_v4 import (
...
def test_train_entry_injects_only_the_store_v4_spec(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        (
            "integrations.rlbench.rlbench_dynamac.store_bottle_v4."
            "build_store_bottle_training_identity"
        ),
...
def test_release_plan_retrains_store_and_only_inherits_everything_else(
    tmp_path: Path,
) -> None:
