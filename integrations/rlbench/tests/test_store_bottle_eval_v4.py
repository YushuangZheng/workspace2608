...
from rlbench_dynamac import direct_evaluate
from rlbench_dynamac import runtime
...
def _plan(index: int, *, base_seed: int = 2_608_000_000):
...
def test_controller_applies_fridge_then_bottle_as_independent_events(monkeypatch):
    plan = _plan(2, base_seed=70)  # both
