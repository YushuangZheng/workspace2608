...
```bash
python -m evaluations.development.phase23_component_ab.run \
  --config evaluations/development/phase23_component_ab/config_v3.json \
  --output evaluations/development/phase23_component_ab/results/v7_reproduction
```
