...
def _replay_case(
    ...
    for current in samples[1:]:
        ...
        belief = updater.update(
            ...
            # Fixed replay supplies the recorded target state whose action
            # generated this observation; the controller query below remains
            # counterfactual and is used only for auditing.
