...
```bash
python -m evaluations.phase4_transaction_integration.run \
  --config evaluations/phase4_transaction_integration/config.json \
  --output evaluations/phase4_transaction_integration/results/v1
```
