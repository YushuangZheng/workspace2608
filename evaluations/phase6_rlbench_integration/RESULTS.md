...
正式逐单元结果、Wilson区间、成对比较、Holm校正、宏平均bootstrap、完整审计和校验和保存在 `evaluations/phase6_formal_evaluation/results/v2/`；PlaceCups消融末端停滞与WipeDesk覆盖率专项审查保存在 `evaluations/phase6_formal_evaluation/NORMAL_AUDIT.md`。旧`results/v1/`汇总已清除，避免与最终Handover最小受影响重跑结果混用。
