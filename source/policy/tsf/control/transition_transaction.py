"""Batch validation and atomic multi-arm skill-boundary commits."""
...
if TYPE_CHECKING:
    from ..inference.belief_updater import BeliefUpdater
...
class TransitionTransactionCoordinator:
    ...
    def __init__(
        ...
        controllers: Mapping[str, TSFExecutionController],
