"""Unified per-tick observation shared by all TSF inference modules."""
...
class RuntimeObservation:
    ...
    node factors learned by the offline task-model builder. Platforms that expose only rigid-body
