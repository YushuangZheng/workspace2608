...
All the environments are registered in the `essay2608` extension. They start
...
import essay2608.tasks  # noqa: F401


def main():
    """Print all environments registered in `essay2608` extension."""
